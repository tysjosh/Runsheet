/**
 * Copied from azumi-rider/components/ui/switch.tsx
 * Copied: 2026-07-29
 ...
 *
 * Changed: the donor read the active scheme from `azumi-rider/lib/useColorScheme`,
 * which is not one of the six copied artifacts (Requirement 16.21). This file
 * reads it from this app's own `hooks/useColorScheme`, defaulting to `light`
 * when the platform reports no preference. No domain logic.
 */
