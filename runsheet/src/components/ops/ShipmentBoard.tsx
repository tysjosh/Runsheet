 ...
 */
export default function ShipmentBoard({ shipments, slaBreachIds }: ShipmentBoardProps) {
  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full" role="grid" aria-label="Shipment status board">
            ...
            return (
              ...
              >
                ...
                <td className="px-6 py-3">
                  ...
                  >
                    {isBreach ? 'SLA Breach' : shipment.status.replace('_', ' ')}
                  </span>
                </td>
