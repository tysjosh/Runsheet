...
def configure_invoice_api(*, invoice_service: InvoiceService) -> None:
    """Wire service dependencies into the invoice API module.

    Called once during application startup so that the router handlers
    can access the shared InvoiceService without circular imports.
    """
...
async def get_invoice(
    ...
    payment totals, and QBO push state.
